...
class Model {
    ...
    init() {
        ...
        frc_program = cdStack.frcForEntityNamed("Program", withPredicateFormat: nil, predicateObject: nil, sortDescriptors: [NSSortDescriptor(key: "credential", ascending: true)], andSectionNameKeyPath: nil)
