...
class Model {
    ...
    let frc_player: NSFetchedResultsController<Player>
    ...
    init() {
        ...
        frc_player = cdStack.frcForEntityNamed("Player", withPredicateFormat: nil, predicateObject: nil, sortDescriptors: [NSSortDescriptor(key: "player", ascending: true)], andSectionNameKeyPath: nil)
